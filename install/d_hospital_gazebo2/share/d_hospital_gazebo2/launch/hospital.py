# Launches the d_hospital in Gazebo to be controlled using a joystick. There are a number of launch arguments that can be toggled.
...
def generate_launch_description():
    ...
    # Inicia Xacro e Nó do start_robot_state_publisher 
    ...
    # Cria o robô dentro do Gazebo
    start_spawner_cmd = Node(
        package="gazebo_ros",
        executable="spawn_entity.py",
        output="screen",
        arguments=["-topic", "robot_description", "-entity", "d_hospital"],
    )

    # Spawn diff_controller
    # Cria o nó do controle diferencial
