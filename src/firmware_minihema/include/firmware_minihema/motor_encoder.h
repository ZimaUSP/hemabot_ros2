...
extern volatile int left_wheel_pulse_count;
extern volatile int right_wheel_pulse_count;
extern volatile int left_wheel_direction;
extern volatile int right_wheel_direction;
