...
#include "minihema_launch/mpu6050_lib.h"
...
int main() {
    ...
    std::cout << "Paste covariance arrays in the imu_broadcaster ros__parameters section in minihema_launch/config/controllers.yaml.\n";
